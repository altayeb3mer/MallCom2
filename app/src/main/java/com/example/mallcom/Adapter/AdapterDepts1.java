...
public class AdapterDepts1 extends RecyclerView.Adapter<AdapterDepts1.ViewHolder> {
...
//    RelativeLayout container;
    public AdapterDepts1(Activity activity, ArrayList<ModelDept> r) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.fragment2_dept, parent, false);
